...
rootPath = r'./data/Physcap/Human36/inputData'
...
for kindPath in kindPaths:
    ...
    for squenceId in squenceIds:
        framesData = motion_data_getter(os.path.join(squenceId,str(0).zfill(10)+'.txt')).T
        sample_contact_path = os.path.join(squenceId,'sample_contact.npy')
        sample_stationary_path = os.path.join(squenceId, 'sample_stationary.npy')
