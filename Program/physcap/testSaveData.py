...
if __name__ == '__main__': 
    length = 10
    physcapResultPath = r'./data/Physcap/Human36/inputData/S11/WalkTogether1/PhyCap_q.npy'
    kinematicResultPath = r'./data/Physcap/Human36/inputData/S11/WalkTogether1/0000000000.txt'
    # smplResultPath = r'./data/Physcap/3Djoints/0034'
    smplResultPath = r'./data/Physcap/Human36/saveData/S11/WalkTogether1'
    ...
    while(p.isConnected()):
        frameIdex = str(int(p.readUserDebugParameter(uid))).zfill(length)
