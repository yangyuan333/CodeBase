...
#         np.savetxt(R'E:\Human-Training-v3.3\VCL Occlusion/3DOH50K_Parameters'+str(idx)+'.txt', exmat)
#         idx+=1
...
if __name__ == '__main__':
    ...
    path = R'E:\Human-Training-v3.3\VCL Occlusion\params'
    ...
    for dir_path in dirs_path:
        ...
        for frame_path in frames_dir:
            ...
            for frame in frames:
                ...
                exmat = np.array(exmats[1])
                vs_2d = Camera_project(vs, exmat, np.array(inmats[1]))
                img = cv2.imread(R'E:\Human-Training-v3.3\VCL Occlusion/00000.jpg')
                for v in vs_2d:
